My Python Package MATLAB Python Package
...
2. Installing the My Python Package Package

A. Change to the directory that contains the file setup.py and the subdirectory My Python 
Package. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the My Python Package Package

The My Python Package package is on your Python path. To import it into a Python script 
or session, execute:
