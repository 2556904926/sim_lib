cyg_matlab_add MATLAB Python Package
...
2. Installing the cyg_matlab_add Package

A. Change to the directory that contains the file setup.py and the subdirectory 
cyg_matlab_add. If you do not have write permissions, copy all its contents to a 
...
3. Using the cyg_matlab_add Package

The cyg_matlab_add package is on your Python path. To import it into a Python script or 
session, execute:

    import cyg_matlab_add
