...
2. Installing the PidTool Package

A. Change to the directory that contains the file setup.py and the subdirectory PidTool. 
...
3. Using the PidTool Package

The PidTool package is on your Python path. To import it into a Python script or session, 
execute:
