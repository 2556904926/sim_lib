classdef NicholsEditorData < ctrlguis.csdesignerapp.data.internal.GraphicalEditorData
    ...
    properties
        ...
        % Nichols specific data properties
    ...
    methods
        function this = NicholsEditorData(Response, varargin)
            ...
            this.DataListeners = [this.DataListeners; ...
                addlistener(Preferences, 'MultiModelFrequencySelectionData',...
                'PostSet', @(es,ed)updateMultiModelFrequency(weakThis.Handle,ed))];
        end
        ...
        function update(this)
            ...
            if isFRD
                ...
                [FRDMagnitude,FRDPhase,FRDFrequency,this.FreqFocus] = nichols(this,TunedLFT);
                ...
                [TFMagnitude,TFPhase,TFFrequency] = nichols(this,TFactors,FRDFrequency);
                ...
                [this.Magnitude, this.Phase, this.Frequency, this.FreqFocus] = nichols(this,NormOpenLoopNominal);
            ...
            if ~b
                ...
                for ct = 1:nsys
                    ...
                    [UMagnitude(:,ct),UPhase(:,ct),uw] = nichols(this,OpenLoop,uw);
                end
                this.UncertainData = struct(...
        ...
        function [m,p,w,Focus] = nichols(this,Dsys,w)
