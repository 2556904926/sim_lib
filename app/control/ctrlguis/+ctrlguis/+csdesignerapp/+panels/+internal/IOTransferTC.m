classdef IOTransferTC < controllib.widget.internal.tc.AtomicComponent
    ...
    methods(Access = public)
        function this = IOTransferTC(CDD,Data)
            ...
            registerDataListeners(this.InputListPanel, ...
                ...
                @(src,data)createFlatContextMenu(this.InputListPanel)));
            registerDataListeners(this.InputListPanel, ...
            ...
            registerDataListeners(this.OutputListPanel, ...
                ...
                @(src,data)createFlatContextMenu(this.OutputListPanel)));
            registerDataListeners(this.OutputListPanel, ...
                addlistener(Data,'Openings','PostSet', ...
                @(src,data)createFlatContextMenu(this.OutputListPanel)));
