    ...
    methods
        ...
        function draw(this)
            if isempty(this.UncertainPatch)
                ...
                controllib.plot.internal.utils.setColorProperty(this.UncertainPatch,...
                    ["FaceColor","EdgeColor"],this.FaceColor);
                this.UncertainLines = line(nan,nan,this.ZLevel,'Parent', NicholsAxes);
                controllib.plot.internal.utils.setColorProperty(this.UncertainLines,...
            ...
            if isVisible(this)
                if strcmpi(this.UncertainType,'Bounds')
                    ...
                    set(this.UncertainPatch,'YData', unitconv(ydata,'abs','db'),...
                        'XData', unitconv(xdata,'deg',char(this.Parent.Axes.PhaseUnit)),'ZData',zdata);
                else
                    ...
                    set(this.UncertainLines,'YData', unitconv(Magdata,'abs','db'),...
                        'XData', unitconv(Phasedata,'deg',char(this.Parent.Axes.PhaseUnit)),'ZData', this.ZLevel * ones(size(Phasedata)));
                end
            else
                set(this.UncertainLines,'visible','off')
                set(this.UncertainPatch,'visible','off')
        ...
        function setColor(this,Color)
            if isnumeric(Color)
                ...
                this.FaceColor = controllib.plot.internal.utils.convertSemanticColor(Color,"tertiary");
            end
