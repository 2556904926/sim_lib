classdef GainEditor < systuneapp.internal.panels.blockeditors.LTIEditor
    ...
    properties(Access = private)
        Gain   controllib.widget.internal.parametereditor.ParameterData
    end

    %% Public Methods
    methods
        function this = GainEditor(variableValue,optionalArguments)
            arguments
                variableValue tunableGain
        ...
        function updateUI(this)
            updateParameterEditorWidget(this,this.Gain);
        end
    end
    ...
    methods (Access = protected)
        function variableValue = getCurrentVariableValue(this)
            ...
            variableValue.Gain = updateVariableValue(this,variableValue.Gain,this.Gain);
        end
        ...
        function updateParameterData(this)
            ...
            variableValue = this.InitialVariableValue;
            this.Gain = controllib.widget.internal.parametereditor.ParameterData(...
                'Gain',variableValue.Gain);
        end
    end
...
%             LTIBlockName = ltipack.createVarName(getLTIBlockName(this));    
            ...
            Gain_Text = generateMATLABCode(this.Gain,default.Gain,variableName);
