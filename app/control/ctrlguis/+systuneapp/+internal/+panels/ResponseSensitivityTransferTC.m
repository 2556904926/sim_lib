classdef (Hidden) ResponseSensitivityTransferTC < controllib.widget.internal.tc.AtomicComponent & ...
    ...
    properties
        ...
        LocationSignalLabel = getString(message('Control:systunegui:SignalListLocationLabelSensitivityTransfer'));
        OpeningSignalLabel = getString(message('Control:systunegui:SignalListOpeningLabelSensitivityTransfer'));         
    end
    ...
    methods(Access = public)
        function this = ResponseSensitivityTransferTC(CDD,ResponseWrapper)
            ...
            this.Create = false;
            this.CDD = CDD;
            this.SensitivityTransferTC = systuneapp.internal.panels.LoopTransferTC(this.CDD,this); 
    ...
    methods(Access = public)
        function setResponse(this,overwriteExistingResponse)
            ...
            try
                ...
                % Create Response
                Response = systuneapp.data.response.SensitivityTransfer(this.Location);
